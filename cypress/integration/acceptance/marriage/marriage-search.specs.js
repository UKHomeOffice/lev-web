...
describe('Marriage search', () => {
  ...
  //     });
  //
  //     it('requests a date of birth or marriage', () => {
  //       MarriageSearchPage.hasErrorMessage('Please enter a date');
  //     });
  //   });
  //
  ...
  //         MarriageSearchPage.hasErrorMessage('Please enter a date in the correct format');
  //       });
  //
  //       it('shows the date of birth/marriage details hint', () => {
  //         MarriageSearchPage.hasDateOfBirthOrMarriageHint();
  //       });
  //
  //       it('the date of birth/marriage field should be focused', () => {
  //         MarriageSearchPage.hasDateOfBirthOrMarriageFocused();
  //       });
  //     });
  //
  ...
  //         MarriageSearchPage.hasErrorMessage('Please enter a date in the past');
  //       });
  //
  //       it('shows the date of birth/marriage details hint', () => {
  //         MarriageSearchPage.hasDateOfBirthOrMarriageHint();
